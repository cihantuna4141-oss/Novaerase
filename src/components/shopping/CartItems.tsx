      ...
      <div className="min-h-screen bg-gray-50">
        <div className="flex flex-col items-center justify-center px-4 py-20">
          ...
          <p className="mb-8 text-center text-gray-500">
            Looks like you haven't added any premium pens yet.
          </p>
          <Link
            href="/"
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="space-y-4 lg:col-span-2">
            {items.map((item) => (
              <div
                key={item.id}
                className="flex items-center gap-4 p-4 bg-white border rounded-2xl"
              >
          ...
          <div className="lg:col-span-1">
            <div className="sticky p-6 bg-white border rounded-2xl top-24">
              ...
              <button
                ...
                className="flex items-center justify-center w-full gap-2 py-2 font-bold text-white transition bg-gray-900 rounded-xl hover:bg-blue-600"
              >

  ...
  return (
    <section className="bg-cream py-24 px-6 border-t border-ink/5">
      <div className="max-w-4xl mx-auto text-center">
        <p className="text-[10px] tracking-[0.3em] text-gold uppercase mb-3 font-bold">See It in Action</p>
        <h2 className="text-4xl font-bold text-ink mb-12">Watch the highlight disappear.</h2>
        
        <div className="group relative aspect-video w-full bg-cream-dark rounded-[2.5rem] overflow-hidden border border-gold/20 shadow-2xl cursor-pointer">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-6 bg-gradient-to-br from-cream-dark to-cream transition-transform duration-700 group-hover:scale-105">
            ...
            <p className="text-xs tracking-[0.1em] text-ink/40 font-medium">NOVAREASE — Highlight Remover Demo</p>
          </div>

...
const Navbar = ({ onOpenModal }: NavProps) => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 bg-cream/88 backdrop-blur-lg border-b border-gold/20 md:px-12">
      <span className="text-lg font-bold tracking-[0.22em] uppercase text-ink">Novarease</span>
